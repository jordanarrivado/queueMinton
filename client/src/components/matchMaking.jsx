 ...
 */
  ...
  const handleDeleteMatch = () => {
    ...
    axios
      .delete(`http://localhost:3001/users/${user.email}/areas/${localArea}/sessions/${sessionDate}/inMatch`)
      .then(() => {
        setInMatch([]);
        return axios.delete(`http://localhost:3001/users/${user.email}/areas/${localArea}/sessions/${sessionDate}/matches`);
      })
      .then(() => {
        setMatches([]);
        setMatchLoading(false);
